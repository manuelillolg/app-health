...
@Controller('app-health/application-databases/paginate')
export class AppHealthPaginateApplicationDatabasesController
{
    constructor(
    ...
    @Post()
    @HttpCode(200)
    @ApiOperation({ summary: 'Paginate application-databases' })
