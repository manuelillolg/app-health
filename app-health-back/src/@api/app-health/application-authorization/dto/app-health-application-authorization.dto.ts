...
export class AppHealthApplicationAuthorizationDto
{
    ...
    @ApiProperty({
        type       : () => AppHealthAuthorizationInterfaceDto,
        description: 'AppHealthAuthorizationInterface [input here api field description]',
    })
    authorizationInterface?: AppHealthAuthorizationInterfaceDto;
